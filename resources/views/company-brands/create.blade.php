...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Add a new trading name and letterhead for your company
                    </p>
                </div>
        ...
        {{-- Form --}}
        <form action="{{ route('settings.brands.store') }}" method="POST" enctype="multipart/form-data">
            @csrf

            @include('company-brands._form', ['brand' => new \App\Models\CompanyBrand()])

<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @endcan
                    @canany(['teams.view', 'teams.manage'])
                    ...
                    @endcan
                    @canany(['pricing.view', 'pricing.manage'])
                    ...
                    @endauth
                    @if(auth()->user() && auth()->user()->can('view audit logs'))
                        <x-nav-link :href="route('audit.index')" :active="request()->routeIs('audit.*')">
                            {{ __('Audit') }}
                        </x-nav-link>
                    @endif
                    @can('manage', App\Models\Company::class)
                        <x-nav-link :href="route('company.show')" :active="request()->routeIs('company.*')">
                            {{ __('Company') }}
                        </x-nav-link>
                    @endcan
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endif
            @can('manage', App\Models\Company::class)
                <x-responsive-nav-link :href="route('company.show')" :active="request()->routeIs('company.*')">
                    {{ __('Company') }}
                </x-responsive-nav-link>
            @endcan
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                <x-responsive-nav-link :href="route('two-factor.setup')">
                    {{ __('Two-Factor Authentication') }}
                </x-responsive-nav-link>

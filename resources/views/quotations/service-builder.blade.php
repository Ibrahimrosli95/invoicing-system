...
@section('content')
<div class="min-h-screen bg-gray-50" x-data="quotationBuilder()">
    <!-- Header Bar -->
    <div class="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-40">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                <a href="{{ route('quotations.index') }}" class="text-gray-500 hover:text-gray-700">
                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </a>
                <h1 class="text-lg font-semibold text-gray-900">Create New Quotation</h1>
            ...
            <div class="flex items-center space-x-3 relative z-50">
                ...
                <button type="button" @click="saveQuotation" class="relative z-50 px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer">
                    Save Quotation
                </button>
            </div>
        </div>
                            ...
                            <div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between items-center">
                                        ...
                                        <span class="text-sm font-mono font-semibold" x-text="quotationNumber">QTN-2025-000001</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <select x-model="validityPeriod" class="text-sm font-medium border-0 border-b border-gray-300 bg-transparent text-right p-0 focus:ring-0 focus:border-blue-500">
                                ...
                                <div class="border border-gray-200 rounded-lg overflow-hidden">
                                    ...
                                    <table class="w-full table-fixed">
                                        <thead class="bg-gray-50 border-b border-gray-200">
                                            <tr>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-center" style="width: 6%; min-width: 60px;">SI</th>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-left align-top" style="width: 52%; min-width: 260px;">Details</th>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-center" style="width: 8%; min-width: 90px;">Unit</th>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-center" style="width: 12%; min-width: 100px;">Qty</th>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-right" style="width: 11%; min-width: 120px;">Rate (RM)</th>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-right" style="width: 11%; min-width: 130px;">Amount (RM)</th>
                                                <th class="px-4 py-3 text-xs font-medium text-gray-500 uppercase text-center" style="width: 40px; min-width: 40px;">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody class="divide-y divide-gray-100">
                                            <template x-for="(item, itemIndex) in section.items" :key="item.id">
                                                <tr class="hover:bg-gray-50 align-top">
                                                    <td class="px-4 py-3 text-center text-sm text-gray-600" style="width: 6%; min-width: 60px;" x-text="itemIndex + 1"></td>
                                                    <!-- Details -->
                                                    <td class="px-4 py-3 align-top" style="width: 52%; min-width: 260px;">
                                                    ...
                                                    <!-- Unit -->
                                                    <td class="px-4 py-3 align-top" style="width: 8%; min-width: 90px;">
                                                    ...
                                                    <!-- Quantity -->
                                                    <td class="px-4 py-3 align-top" style="width: 12%; min-width: 100px;">
                                                    ...
                                                    <!-- Rate -->
                                                    <td class="px-4 py-3 align-top" style="width: 11%; min-width: 120px;">
                                                        <input type="text"
                                                               inputmode="decimal"
                                                               ...
                                                               class="w-full border-0 bg-transparent text-sm text-right focus:ring-0 px-3 pr-2 min-w-[7.5rem]"
                                                               placeholder="0.00">
                                                    </td>
                                                    <!-- Amount (Editable with Override Indicator) -->
                                                    <td class="px-4 py-3 align-top" style="width: 11%; min-width: 130px;">
                                                        <div class="flex items-center justify-end gap-2 min-w-[8rem]">
                                                            <input type="text"
                                                                   inputmode="decimal"
                                                                   ...
                                                                   class="w-full border rounded-md px-3 py-2 text-sm text-right focus:ring-0 focus:border-blue-500 min-w-[8rem]"
                                                                   placeholder="0.00">
                                                    ...
                                                    <div class="grid grid-cols-3 gap-2">
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   @blur="finalizeCurrencyInput(sectionIndex, itemIndex, 'unit_price')"
                                                                   @input="handleCurrencyInput(sectionIndex, itemIndex, 'unit_price', $event.target.value)"
                                                                   class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm text-right focus:ring-blue-500 focus:border-blue-500 min-w-[7.5rem]"
                                                                   placeholder="0.00">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="flex items-center justify-between gap-2">
                                                            ...
                                                            <div class="flex items-center gap-2">
                                                                <input type="text"
                                                                       ...
                                                                       class="min-w-[8.5rem] border rounded-md px-3 py-2 text-sm text-right focus:ring-blue-500 focus:border-blue-500"
                                                                       placeholder="0.00">
                                                                <!-- Reset Override Button -->
                                                                <button type="button"
                                                                        x-show="item.amount_manually_edited"
            ...
            <div class="relative bg-white rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
                    ...
                    <div class="preview-invoice">
                        ...
                        <table style="width: 100%;"><tr>
                            ...
                            <td style="width: 50%; vertical-align: top;">
                                <div class="preview-section-label">Quotation Info</div>
                                <div class="preview-card"><table style="width: 100%;">
                                    <tr><td style="font-weight: 600; color: #4b5563; padding: 2px 0;">Quotation No :</td><td style="padding: 2px 0;" x-text="quotationNumber"></td></tr>
                                    <tr><td style="font-weight: 600; color: #4b5563; padding: 2px 0;">Quotation Date :</td><td style="padding: 2px 0;" x-text="quotationDateDisplay"></td></tr>
                                    <tr><td style="font-weight: 600; color: #4b5563; padding: 2px 0;">Valid Until :</td><td style="padding: 2px 0;" x-text="validUntilDisplay"></td></tr>
                                </table></div>
                            </td>
                        </tr></table>
                ...
                <div class="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button @click="modals.preview = false; saveQuotation()"
...
function quotationBuilder() {
    return {
        ...
        // Quotation Data
        currentQuotationId: null, // Track the current draft quotation to avoid duplicates
        quotationNumber: 'QTN-2025-000001',
        quotationDate: new Date().toISOString().split('T')[0],
        quotationDateDisplay: '',
        validUntil: '',
        validUntilDisplay: '',
        ...
        init() {
            ...
            this.quotationDateDisplay = this.formatDateDDMMYYYY(today);

            const validUntilDate = new Date();
            validUntilDate.setDate(validUntilDate.getDate() + parseInt(this.validityPeriod));
            this.validUntil = validUntilDate.toISOString().split('T')[0];
            this.validUntilDisplay = this.formatDateDDMMYYYY(validUntilDate);

            // Calculate initial totals
            this.calculateTotals();

            // Load quotation settings
            this.loadQuotationSettings();
        ...
        updateQuotationDate() {
            ...
            let value = this.quotationDateDisplay.replace(/[^\d]/g, '');
            if (value.length >= 2) {
            ...
            this.quotationDateDisplay = value.substr(0, 10);

            // Update internal date if valid
            const parsed = this.parseDDMMYYYY(this.quotationDateDisplay);
            if (parsed) {
                this.quotationDate = parsed.toISOString().split('T')[0];
            }
        },

        updateValidUntil() {
            // Auto-format as user types
            let value = this.validUntilDisplay.replace(/[^\d]/g, '');
            if (value.length >= 2) {
                value = value.substr(0, 2) + '/' + value.substr(2);
            }
            if (value.length >= 5) {
            ...
            this.validUntilDisplay = value.substr(0, 10);

            // Update internal date if valid
            const parsed = this.parseDDMMYYYY(this.validUntilDisplay);
            if (parsed) {
                this.validUntil = parsed.toISOString().split('T')[0];
            }
        },
        ...
        loadQuotationSettings() {
            // Note: Quotations may use similar settings structure to invoices
            // For now, we'll use default settings initialized in the data
            // Future enhancement: create quotation-specific settings API

            // Load columns configuration (shared with invoices)
        ...
        previewPDF() {
            ...
            this.$dispatch('notify', { type: 'info', message: 'Showing preview. Save quotation to generate PDF.' });
        },
        ...
        saveQuotation() {
            ...
            .then(data => {
                if (data.success) {
                    this.$dispatch('notify', { type: 'success', message: 'Quotation saved successfully! Redirecting...' });
                    // Redirect to quotation view where PDF preview is available
                    setTimeout(() => {
                        window.location.href = `/quotations/${data.quotation.id}`;
                    }, 1500);
                } else {
                    this.$dispatch('notify', { type: 'error', message: data.message || 'Failed to save quotation' });
                }
            })
            .catch(error => {
                console.error('Save quotation error:', error);
                this.$dispatch('notify', { type: 'error', message: 'Failed to save quotation' });
            });
        },

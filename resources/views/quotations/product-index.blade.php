...
@section('title', 'Product Quotations')

@section('header')
<div class="bg-white border-b border-gray-200 px-6 py-4">
    <div class="flex items-center justify-between">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Product Quotations') }}
        </h2>
    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-4">
                    <form method="GET" action="{{ route('quotations.product-index') }}" class="space-y-4">
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    @if(request()->hasAny(['search', 'status', 'team_id', 'customer_segment_id', 'assigned_to', 'date_from', 'date_to']))
                                        <a href="{{ route('quotations.product-index') }}"

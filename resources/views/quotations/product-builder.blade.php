        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white rounded-lg shadow-xl max-w-5xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div class="sticky top-0 z-10 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-900">Quotation Preview</h3>
                        <p class="text-sm text-gray-500 mt-1">Save quotation to generate PDF version</p>
                    </div>
                ...
                <div class="p-6">
                    ...
                    <div class="preview-invoice">
                        ...
                        <div class="preview-footer">{{ auth()->user()->company->name ?? 'Company' }} • Quotation <span x-text="quotationNumber"></span> • Preview Generated</div>
                    </div>
                </div>
                ...
                <div class="sticky bottom-0 bg-gray-50 border-t border-gray-200 px-6 py-4 flex items-center justify-between">
                    <p class="text-sm text-gray-600">
                        ...
                        This is a preview only. Save quotation to generate PDF.
                    </p>
    ...
    return {
        ...
        previewPDF() {
            ...
            if (this.currentQuotationId) {
                window.open(`/quotations/${this.currentQuotationId}/preview`, '_blank');

...
<?php $__env->startSection('content'); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900"><?php echo e(number_format($stats['total_activities'])); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['users_active']); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900"><?php echo e($stats['models_affected']); ?></dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">
                                        <?php echo e(number_format($stats['total_activities'] / max($days, 1))); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <?php if(count($stats['actions_breakdown']) > 0): ?>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($user->user_name ?: 'Unknown User'); ?>

                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">
                                        <?php echo e(number_format($user->activity_count)); ?> activities
                                    </div>
                                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="space-y-3">
                            <?php $__empty_1 = true; $__currentLoopData = $topModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded-md">
                                    <div class="flex items-center">
                                    ...
                                    <div class="text-sm text-gray-500">
                                        <?php echo e(number_format($model['count'])); ?> changes
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                ...
                                <div class="flex items-center justify-between p-3 border border-gray-200 rounded-md">
                                    <div class="flex items-center space-x-3">
                                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium
                                            <?php echo e($activity->event === 'deleted' ? 'bg-red-100 text-red-800' : ''); ?>

                                            <?php echo e($activity->event === 'failed_login' ? 'bg-yellow-100 text-yellow-800' : ''); ?>

                                            <?php echo e($activity->event === 'permission_denied' ? 'bg-orange-100 text-orange-800' : ''); ?>">
                                            <?php echo e($activity->getEventDisplayName()); ?>

                                        </span>
                                        <div>
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($activity->getUserDisplayName()); ?>

                                            </div>
                                            <div class="text-xs text-gray-500">
                                                <?php echo e(class_basename($activity->auditable_type)); ?> #<?php echo e($activity->auditable_id); ?>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="<?php echo e(route('audit.index', ['event' => 'failed_login'])); ?>"
                        ...
                        <a href="<?php echo e(route('audit.index', ['event' => 'deleted'])); ?>"
                           class="block p-4 border border-gray-200 rounded-md hover:bg-gray-50">
                            <div class="flex items-center">
                        ...
                        <a href="<?php echo e(route('audit.index', ['event' => 'permission_denied'])); ?>"
                           class="block p-4 border border-gray-200 rounded-md hover:bg-gray-50">
                            <div class="flex items-center">
    ...
    <script>
        ...
        new Chart(eventsCtx, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode(array_map('ucfirst', array_keys($stats['events_breakdown']))); ?>,
                datasets: [{
                    data: <?php echo json_encode(array_values($stats['events_breakdown'])); ?>,
                    backgroundColor: [
        ...
        const dailyData = <?php echo json_encode($stats['daily_activity']); ?>;
        ...
        new Chart(actionsCtx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode(array_map(function($action) {
                    return ucfirst(str_replace('_', ' ', $action));
                }, array_keys($stats['actions_breakdown']))); ?>,
                datasets: [{
                    label: 'Count',
                    data: <?php echo json_encode(array_values($stats['actions_breakdown'])); ?>,
        ...
        function changeDayFilter() {
            ...
            window.location.href = `<?php echo e(route('audit.dashboard')); ?>?days=${days}`;
        }
    </script>
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/d/Bina Invoicing System/resources/views/audit/dashboard.blade.php ENDPATH**/ ?>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="bg-white p-4 rounded-lg border text-center">
                                    <?php if(str_starts_with($qrCodeImage, 'data:image')): ?>
                                        <img src="<?php echo e($qrCodeImage); ?>" alt="QR Code" class="mx-auto">
                                    <?php else: ?>
                                        <p class="text-sm text-gray-600">Fallback URL: <code class="bg-gray-100 px-2 py-1 rounded"><?php echo e($qrCodeImage); ?></code></p>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <button onclick="navigator.clipboard.writeText('<?php echo e($secret); ?>')" class="mt-2 text-sm text-blue-600 hover:text-blue-800">
                                        Copy to clipboard
                                    </button>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <form method="POST" action="<?php echo e(route('two-factor.enable')); ?>" class="mt-6 space-y-4">
                                    <?php echo csrf_field(); ?>
                                    <div>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php else: ?>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                        ...
                        <p class="text-sm text-green-600 mb-4">Enabled on <?php echo e(auth()->user()->two_factor_enabled_at?->format('M j, Y \a\t g:i A')); ?></p>
                    ...
                    <?php if(session('two_factor_recovery_codes') || $backupCodes): ?>
                        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                            ...
                            <div class="bg-white border rounded-lg p-4 mb-4">
                                <div class="grid grid-cols-2 gap-2 font-mono text-sm">
                                    <?php $__currentLoopData = session('two_factor_recovery_codes', $backupCodes ?? []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="bg-gray-50 p-2 rounded text-center"><?php echo e($code); ?></div>
                            ...
                            <div class="flex space-x-4">
                                ...
                                <a href="<?php echo e(route('two-factor.download-recovery-codes')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700">
                    ...
                    <div id="regenerateForm" class="hidden bg-yellow-50 border border-yellow-200 rounded-lg p-6">
                        ...
                        <form method="POST" action="<?php echo e(route('two-factor.regenerate-recovery-codes')); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="mb-4">
...
function printCodes() {
    const codes = <?php echo json_encode(session('two_factor_recovery_codes', $backupCodes ?? []), 512) ?>;
    let printContent = `
        <html>
        <head>
        ...
        <body>
            <div class="header">
                ...
                <p>Account: ${<?php echo json_encode(auth()->user()->email, 15, 512) ?>}</p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /mnt/d/Bina Invoicing System/resources/views/auth/two-factor/setup.blade.php ENDPATH**/ ?>